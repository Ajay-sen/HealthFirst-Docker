...
const API_URL = 'https://healthfirst-docker-backend.onrender.com/api/doctors/getalldoctors'
...
export default function Doctor() {
  ...
  try{
const res=await axios.get(`https://healthfirst-docker-backend.onrender.com/api/doctors/filtereddoctors/${query}`);
